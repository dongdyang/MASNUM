...
!  integer, parameter :: jl    = 12 ! yinxq 2011/9/27 10:27:08
  integer, parameter :: jl    = 36
...
!-------------------------------------------------------------------------------
  ...
  real, allocatable :: grids(:, :)              ! --- (ixl, iyl)
...
!-------------------------------------------------------------------------------
  ...
  allocate(pein(ixl, iyl), peds(ixl, iyl), pebo(ixl, iyl), grids(ixl, iyl))
